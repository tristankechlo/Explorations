...
public abstract class ImprovedJigsawStructure extends Structure {
    ...
    public record JigsawStructureSettings(
        ...
        public static final MapCodec<JigsawStructureSettings> CODEC = RecordCodecBuilder.mapCodec(
                instance -> instance.group(
                        StructureTemplatePool.CODEC.fieldOf("start_pool").forGetter(JigsawStructureSettings::startPool),
