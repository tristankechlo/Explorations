...
/*
    ...
    public static void addStatuesToVillage(Registry<StructureTemplatePool> poolRegistry, Registry<StructureProcessorList> processorListRegistry) {
        addBuildingToPool(poolRegistry, processorListRegistry, new ResourceLocation("minecraft:village/plains/houses"), 1);
    }
    ...
    private static void addBuildingToPool(Registry<StructureTemplatePool> templatePoolRegistry, Registry<StructureProcessorList> processorListRegistry,
                                          ResourceLocation poolRL, int weight) {
