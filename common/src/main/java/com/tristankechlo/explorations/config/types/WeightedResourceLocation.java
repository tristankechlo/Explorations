...
public record WeightedResourceLocation(Identifier location, Integer weight) {

    public static final Codec<WeightedResourceLocation> CODEC = RecordCodecBuilder.create(
            instance -> instance.group(
                    Identifier.CODEC.fieldOf("location").forGetter(WeightedResourceLocation::location),
